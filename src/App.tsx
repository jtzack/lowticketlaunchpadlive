...
function SessionRoadmap() {
  const sessions = [
    ...
    { num: 3, date: 'Fri May 1', title: 'Launching Your First Mini-Product', desc: "Get your product listed, your checkout working, and your first marketing assets in place. Pin it to your social profiles, set up your evergreen CTA, and send the launch.", deliverable: 'Your first digital product live and for sale.' },
    { num: 4, date: 'Mon May 4', title: '$350 Digital Product Offer Creation & Bonus Bundling', desc: "Turn the problem from your $99 template into a full digital course. Stack bonuses, create irresistible offers, and price your course so it feels like a no-brainer.", deliverable: 'A complete offer stack with bonus bundle ready to build.' },
    { num: 5, date: 'Wed May 6', title: 'Outline Your Digital Course In 1 HR', desc: "Use a proven AI-assisted framework to go from a blank page to a full course outline in a single session. Module structure, lesson flow, and deliverables \u2014 all mapped out.", deliverable: 'A complete course outline with every module mapped.' },
    { num: 6, date: 'Fri May 8', title: 'Evergreen Marketing Strategies & Launch Strategies', desc: "Build the system that keeps your products selling long after launch day. Map your full funnel \u2014 social traffic, email opt-ins, landing page visits, and conversion rates.", deliverable: 'An evergreen marketing strategy and revenue tracking system.' },
  ]
