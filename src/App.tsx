...
function SessionRoadmap() {
  const sessions = [
    ...
    { num: 5, date: 'Wed May 6', title: 'How To Outline Your Digital Course In 1 Hour', desc: "Use a proven AI-assisted framework to go from a blank page to a full course outline in a single session. Module structure, lesson flow, and deliverables \u2014 all mapped out.", deliverable: 'A complete course outline with every module mapped.' },
